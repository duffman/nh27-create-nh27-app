...
const serviceProviderManager = serviceProviderManager_1.ServiceProviderManager.getInstance();
...
const sendMessage = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const serviceRouter = new chatServiceRouter_1.ChatServiceRouter(serviceProviderManager);
    const response = yield serviceRouter.routeMessage(message);
